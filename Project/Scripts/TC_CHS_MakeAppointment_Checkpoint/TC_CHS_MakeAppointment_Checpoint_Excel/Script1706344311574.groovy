...
WebUI.setText(findTestObject('CURA Healthcare Service Button/Page_CURA Healthcare Service/input_Password_password'), 'ThisIsNotAPassword')

WebUI.click(findTestObject('CURA Healthcare Service Button/Page_CURA Healthcare Service/button_Login'))

WebUI.verifyCheckpoint(findCheckpoint('Checkpoints/CHS_checkpoint_MakeAppointment/CHS_MakeAppointment_Excel_Checkpoint'), 
    true)
...
WebUI.click(findTestObject('CURA Healthcare Service Button/Page_CURA Healthcare Service/input_Apply for hospital readmission_hospital_readmission'))
...
WebUI.setText(findTestObject('CURA Healthcare Service Button/Page_CURA Healthcare Service/textarea_Comment_comment'), 'This is Checkpoint Appointment')
