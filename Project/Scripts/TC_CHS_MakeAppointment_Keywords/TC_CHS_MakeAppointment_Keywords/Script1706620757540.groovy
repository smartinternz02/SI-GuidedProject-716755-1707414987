...
CustomKeywords.'com.katalon.csh.KeywordsElement.CheckDropElementKatalon'(findTestObject('CURA Healthcare Service Button/Page_CURA Healthcare Service/Facility'), 
...
WebUI.setText(findTestObject('CURA Healthcare Service Button/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Hi This keyword')
